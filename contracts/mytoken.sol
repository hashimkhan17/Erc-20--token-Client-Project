...
contract Token {
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        // Ensure sending is to a valid address! 0x0 address can be used to burn() 
    ...
    /// @notice Mint new tokens and send them to the provided address
    /// @param _to The address to which tokens will be minted
    /// @param _value The amount of tokens to mint
    /// @return success as true for successful minting
    ...
    /// @notice Approve other to spend on your behalf e.g., an exchange 
    ...
    /// @notice transfer by an approved person from the original address of an amount within the approved limit 
    /// @param _from, address sending to and the amount to send
    /// @param _to receiver of token
    /// @param _value amount value of token to send
    /// @dev internal helper transfer function with required safety checks
    /// @return true, success once transferred from the original account    
    // Allow _spender to spend up to _value on your behalf
